        ...
        <div class="grid items-center grid-cols-1 gap-3 mb-5 2xl:grid-cols-12">
            ...
            <div class="2xl:col-span-3 2xl:col-start-10">
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('users.create') }}" type="button" class="flex items-center text-white btn bg-green-500 border-green-500 hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/20 text-nowrap">
                        <i data-lucide="user-round-plus" class="inline text-xs align-middle ltr:pr-1 rtl:pl-1"></i>
                        Add New
                    </a>
                    <a href="{{ route('users.create') }}" type="button" class="flex items-center text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20 text-nowrap">
