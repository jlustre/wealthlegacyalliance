<div class="col-span-12 card 2xl:col-span-12">
    <div class="mb-2 p-4 border-b border-slate-200">
      <h6 class="text-15">{{ $editMode ? __('Edit User Account') : __('Create A New User Account') }}</h6>
    </div><!--end grid-->
    <form wire:submit.prevent="saveUser" class="mt-5" id="createUserForm">
      @csrf
        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4 p-4">
            <div class="mb-4">
