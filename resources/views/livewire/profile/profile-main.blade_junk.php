  ...
  <div class="lg:col-span-9">
    <div class="mt-1 -ml-3 -mr-3 rounded-none card">
      <div class="card-body !px-2.5">
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-9 2xl:grid-cols-9">
          <div class="lg:col-span-6 2xl:col-span-7">
            <div class="flex items-center justify-between gap-3">
              @include('partials.profile.profile-image')
              @include('partials.profile.name-title')
            </div>
          </div>
        </div> !--end grid 9-->

            <div class="lg:col-span-12 2xl:col-span-12">
              @include('partials.profile.statistics')
              ...
              @include('partials.profile.soc-med-links')
            </div>

          </div>

          <div class="lg:col-span-4 2xl:col-span-3">
            @include('partials.profile.top-menu-right')
          </div>
