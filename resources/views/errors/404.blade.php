...
<head>
    ...
    <meta charset="utf-8">
    <title>404 | Wealth Legacy Alliance</title>
    ...
    <div class="mb-0 border-none shadow-none lg:w-[500px] card bg-white/70 dark:bg-zink-500/70">
        <div class="!px-10 !py-12 card-body">
          ...
          <div class="mt-8 text-center">
              ...
              <p class="mb-6 text-slate-500 dark:text-zink-200">Don't worry, you can always go back to the <a href="/">homepage</a> or try searching for what you need.</p>
